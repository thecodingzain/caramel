...
urlpatterns = [
    ...
    path('add-to-wishlist/<int:product_id>/', views.add_to_wishlist, name='add-to-wishlist'),
     path('toggle_wish_list/<int:product_id>/', views.toggle_wish_list, name='toggle_wish_list'),
    ...
    path('accounts/edit-address/', views.AddressView.as_view(), name="edit-address"),
